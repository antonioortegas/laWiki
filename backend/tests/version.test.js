...
const Version = require('../src/models/versionModel'); // Importa el modelo de Version
...
describe('Version Tests', () => {
  ...
  it('should create a new version', async () => {
    const newVersion = {
      entry: "Prueba1", // Reemplaza con un ObjectId válido
      content: "Contenido de prueba para una Versión de prueba",
      createdBy: "nachoK66" // Reemplaza con un ObjectId válido
    };
  ...
  it('should delete a version by ID', async () => {
    ...
    expect(response.body.message).toBe('Versión no encontrada');
  });
});
